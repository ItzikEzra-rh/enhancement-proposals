...
class TestPlanHooks:
    ...
    def _generate_prompt(self):
        return (
            ...
            "IMPORTANT: All component repos are available in your working directory. "
            "Browse them to find real test files, fixtures, and code patterns:\n"
            "- fulfillment-service/internal/servers/ — Go unit tests (Ginkgo)\n"
            "- fulfillment-service/it/ — Go integration tests (kind cluster)\n"
            "- osac-operator/internal/controller/ — controller tests (envtest)\n"
            "- osac-test-infra/tests/ — E2E tests (pytest)\n"
            "- enhancement-proposals/enhancements/ — EP design docs\n"
            "Reference REAL file paths from these repos in your test scenarios.\n\n"
